...
QString compileSrc(QString src,//要编译的源码
                   ...
                   CharCodeSystem charCodeSys,//使用的字符编码系统
    ...
    srcObjInfo.cstringCodeSystem = charCodeSys;
    ...
    title +=        "#适用内存字节序:"+QString(ramEndian==BIG_ENDIAN ? "大端字节序" : "小端字节序")+"\r\n";
    title +=        "#使用的字符串编码格式:"+QString(charCodeSys==CharCode_GBK ? "GBK" : (charCodeSys==CharCode_UTF8 ? "UTF8": "UTF16"))+"\r\n";
    title +=        "#开源项目地址:https://gitee.com/enlighten7328/OpenQinling\r\n";
    title +=        "#作者抖音号:I_am_a_big_fool4\r\n";
    title +=        "#作者哔站号:咋都是名称已存在\r\n";
    title +=        "#作者邮箱号:1969798169@qq.com\r\n";
